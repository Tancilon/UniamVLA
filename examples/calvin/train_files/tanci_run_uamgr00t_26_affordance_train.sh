...
CONFIG_YAML="${CONFIG_YAML:-./examples/calvin/train_files/tanci_run_uamgr00t_26_affordance_train.yaml}"
NUM_GPUS="${NUM_GPUS:-4}"
...
RUN_ID="${RUN_ID:-uamvla_gr00t_starvla26_calvin_d_affordance}"
