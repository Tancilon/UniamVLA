#!/usr/bin/env bash
# UamGR00T_GIA — Geometry·Interaction·Action three-head training on CALVIN ABC.
#
# Sidecar prerequisites (per scene A/B/C):
...
CONFIG_YAML="${CONFIG_YAML:-./examples/calvin/train_files/run_uamgr00t_GIA_calvin.yaml}"
NUM_GPUS="${NUM_GPUS:-4}"
...
RUN_ID="${RUN_ID:-uamvla_gr00t_gia_calvin_abc}"
