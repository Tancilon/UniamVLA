...
CONFIG_YAML="${CONFIG_YAML:-./examples/calvin/train_files/run_uamgr00t_hR_recon_train_abc.yaml}"
NUM_GPUS="${NUM_GPUS:-4}"
...
RUN_ID="${RUN_ID:-uamvla_gr00t_hR_starvla26_calvin_abc_recon_split}"
